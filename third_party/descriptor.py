...
class Descriptor(object):
  ...
  def viewer_init(self, w, h):
    ...
    # self.dcam.SetBounds(
    #     pangolin.Attach(0.0),  # left  = 0.0 (relative), 0 px offset
    #     pangolin.Attach(1.0),  # right = 1.0
    #     pangolin.Attach(0.0),  # bottom = 0.0
    #     pangolin.Attach(1.0),  # top    = 1.0
    #     -aspect                   # same aspect ratio parameter you had
    # )
